namespace Pilot.NET.iPilotnterop
{
    ...
    /// <summary>
    /// The default graphical interop for PILOT
    /// </summary>
    public sealed class GraphicalInterface : IiPilotnterop
    {
        ...
        /// </summary>
        private iPilotInterfaceGraphicsForm graphicsForm;
        ...
        public void PlaySound(double frequency, int playMilliseconds)
        {
            ...
            // var init
            double actualAmplitude = ((GraphicalInterface.AMPLITUDE * (System.Math.Pow(2, 15))) / 1000) - 1;
            ...
            using (MemoryStream ms = new MemoryStream(44 + numBytes))
            {
                using (BinaryWriter bw = new BinaryWriter(ms))
                {
                    ...
                    for (int j = 0; j < numSamples; j++)
                    {
                        ...
                        short s = (short)(GraphicalInterface.AMPLITUDE * (Math.Sin(t * frequency * 2.0 * Math.PI)));
                        bw.Write(s);
                    }
        ...
        private void CreateGraphicsFormIfNeeded()
        {
            ...
            {
                this.graphicsForm = iPilotInterfaceGraphicsForm.ShowForm(this.GraphicsOutput);
            }
        }
    }
}
