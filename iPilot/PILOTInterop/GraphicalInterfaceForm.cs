namespace Pilot.NET.iPilotnterop
{
    using System;
    ...
    /// </summary>
    internal partial class iPilotInterfaceGraphicsForm : Form
    {
        ...
        private iPilotInterfaceGraphicsForm(Image graphicsImage)
        {
        ...
        public static iPilotInterfaceGraphicsForm ShowForm(Image graphicsImage)
        {
            iPilotInterfaceGraphicsForm frm = new iPilotInterfaceGraphicsForm(graphicsImage);
            Thread t = new Thread(new ParameterizedThreadStart(iPilotInterfaceGraphicsForm.MessagePump));
        ...
        {
            iPilotInterfaceGraphicsForm frm = (iPilotInterfaceGraphicsForm)obj;
            Application.Run(frm);
            frm.Dispose();
        }
