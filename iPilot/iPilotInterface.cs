namespace iPilot
{
    ...
    /// </summary>
    internal sealed class iPilotInterface : IPILOTExternalInterface
    {
        ...
        /// </summary>
        private PilotInterfaceGraphicsForm graphicsForm;
        ...
        public iPilotInterface(int width, int height)
        {
        ...
        public void PlaySound(double frequency, int playMilliseconds)
        {
            ...
            // var init
            double actualAmplitude = ((iPilotInterface.AMPLITUDE * (System.Math.Pow(2, 15))) / 1000) - 1;
            ...
            using (MemoryStream ms = new MemoryStream(44 + numBytes))
            {
                using (BinaryWriter bw = new BinaryWriter(ms))
                {
                    ...
                    for (int j = 0; j < numSamples; j++)
                    {
                        ...
                        short s = (short)(iPilotInterface.AMPLITUDE * (Math.Sin(t * frequency * 2.0 * Math.PI)));
                        bw.Write(s);
                    }
        ...
        private void CreateGraphicsFormIfNeeded()
        {
            ...
            {
                this.graphicsForm = PilotInterfaceGraphicsForm.ShowForm(this.GraphicsOutput);
            }
        }
    }
}
